  ...
  return (
    <div className="p-6 space-y-4">
      <div className="flex items-center gap-3 p-3 bg-green-50 border border-green-200 rounded-xl">
        ...
        <p className="text-sm text-green-700">Sign in with your <strong>DRCP account</strong> to submit referrals directly to the platform.</p>
      </div>
